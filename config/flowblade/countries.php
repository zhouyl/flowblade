...
/**
 * Flowblade Countries Configuration
 *
 * This file contains the list of countries with their ISO codes, dial codes, and flag emojis.
 * Used by the PhoneInput component for international phone number input.
 *
 * Format:
 * 'ISO_CODE' => [
 *     'name' => 'Country Name',
...
return [
    'countries' => [
        ...
        'SZ' => ['name' => 'Eswatini', 'code' => '+268', 'flag' => '🇸🇿'],
