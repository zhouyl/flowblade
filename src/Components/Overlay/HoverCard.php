...
class HoverCard extends Component
{
    ...
    {
        $classes = [
            'absolute z-10 invisible inline-block text-sm font-light text-gray-500 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800',
        ];
