...
<div class="space-y-8">
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-states" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-group" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-with-description" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-sizes" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-colors" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.checkbox.checkbox-in-form" />
