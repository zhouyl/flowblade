...
<div class="space-y-8">
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.textarea.textarea-with-counter" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.textarea.textarea-validation" />
    ...
    <div class="preview-section">
        ...
        <x-preview file="flowblade::preview.codes.textarea.textarea-in-form" />
