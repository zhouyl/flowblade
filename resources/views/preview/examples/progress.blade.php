...
<div class="space-y-8">
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="65" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="25" /&gt;
&lt;x-progress value="50" /&gt;
&lt;x-progress value="75" /&gt;
&lt;x-progress value="100" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="60" color="primary" /&gt;
&lt;x-progress value="60" color="success" /&gt;
&lt;x-progress value="60" color="warning" /&gt;
&lt;x-progress value="60" color="danger" /&gt;
&lt;x-progress value="60" color="info" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="50" size="sm" /&gt;
&lt;x-progress value="50" size="md" /&gt;
&lt;x-progress value="50" size="lg" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;div class="flex items-center justify-between mb-2"&gt;
    &lt;p class="text-sm text-gray-600"&gt;Progress&lt;/p&gt;
    &lt;p class="text-sm font-medium"&gt;45%&lt;/p&gt;
&lt;/div&gt;
&lt;x-progress value="45" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="50" striped /&gt;
&lt;x-progress value="65" striped color="success" /&gt;
&lt;x-progress value="80" striped color="warning" /&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-progress value="50" striped animated /&gt;
&lt;x-progress value="65" striped animated color="success" /&gt;
&lt;x-progress value="80" striped animated color="warning" /&gt;</code></pre>
        </div>
    </div>
