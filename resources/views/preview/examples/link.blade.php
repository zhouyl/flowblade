...
<div class="space-y-8">
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="https://example.com"&gt;Visit Example&lt;/x-link&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="#" color="primary"&gt;Primary Link&lt;/x-link&gt;
...
&lt;x-link href="#" color="warning"&gt;Warning Link&lt;/x-link&gt;
&lt;x-link href="#" color="info"&gt;Info Link&lt;/x-link&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="#" size="sm"&gt;Small Link&lt;/x-link&gt;
&lt;x-link href="#" size="md"&gt;Medium Link&lt;/x-link&gt;
&lt;x-link href="#" size="lg"&gt;Large Link&lt;/x-link&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="#" variant="default"&gt;Default Link&lt;/x-link&gt;
&lt;x-link href="#" variant="underline"&gt;Underlined Link&lt;/x-link&gt;
&lt;x-link href="#" variant="hover"&gt;Hover Link&lt;/x-link&gt;</code></pre>
        </div>
    </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="#" class="flex items-center gap-1"&gt;
    &lt;svg&gt;...&lt;/svg&gt;
    External Link
&lt;/x-link&gt;</code></pre>
        </div>
    ...
    <div class="preview-section">
        ...
        <div class="preview-code bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
            <pre class="font-mono text-sm"><code>&lt;x-link href="#"&gt;Normal Link&lt;/x-link&gt;
&lt;x-link href="#" class="opacity-50 cursor-not-allowed"&gt;Disabled&lt;/x-link&gt;
&lt;x-link href="#" class="font-semibold"&gt;Active Link&lt;/x-link&gt;</code></pre>
        </div>
    </div>
    ...
    Check out our &lt;x-link href="#"&gt;documentation&lt;/x-link&gt;
&lt;/p&gt;</code></pre>
        </div>
    </div>
</div>
