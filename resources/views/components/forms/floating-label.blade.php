@php
    // Size classes
    $sizeClasses = [
        'sm' => 'text-xs px-2.5 pb-1.5 pt-3',
        'md' => 'text-sm px-2.5 pb-2.5 pt-4',
        'lg' => 'text-base px-3 pb-3 pt-5',
    ];
    ...
    $inputClasses = $variantClasses[$variant] . ' ' . $sizeClasses[$size] . ' ' . $colorClasses;
    $labelClasses = 'absolute duration-300 transform -translate-y-4 scale-75 origin-[0] peer-focus:start-0 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 ' . $labelSizeClasses[$size] . ' ' . $labelColorClasses;
