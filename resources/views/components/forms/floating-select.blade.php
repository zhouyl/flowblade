@php
    ...
    $selectClasses = $variantClasses[$variant] . ' text-sm px-2.5 pb-2.5 pt-4 ' . $colorClasses;
    $labelClasses = 'absolute text-sm duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] peer-focus:start-0 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto ' . $labelColorClasses;
